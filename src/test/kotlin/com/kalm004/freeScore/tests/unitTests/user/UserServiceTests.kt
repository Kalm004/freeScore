...
class UserServiceTests {
    ...
    @Test
    fun testGetAllUsers() {
        given(userRepository.getAll()).willReturn(setOf(User(1, "Test", "hash", "a@a.com","USER")))
        assertEquals(
                setOf(User(1, "Test", "hash", "a@a.com", "USER")),
    ...
    fun testCreateUser() {
        ...
        // then:
        Mockito.verify(userRepository).createUser("User", "\$2a\$10\$g7BNVysi8m9Ho6w8YT6YnuADwpg3d8Q9l3lapXDQGZF2M/HH3X9ca", "user@server.com")
    }
}